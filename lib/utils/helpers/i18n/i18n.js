...
var I18nHelper = {
  ...
  abbreviateNumber: function abbreviateNumber(num) {
    if (num > 949 && num < 999950) {
      return "" + I18nHelper.roundForAbbreviation(num, 100) + _i18nJs2.default.t("number.format.abbreviations.thousand", { defaultValue: "k" });
    } else if (num > 999949) {
      return "" + I18nHelper.roundForAbbreviation(num, 100000) + _i18nJs2.default.t("number.format.abbreviations.million", { defaultValue: "m" });
    }
