...
var Heading = function (_React$Component) {
  ...
  _createClass(Heading, [{
    ...
    key: 'back',
    get: function get() {
      if (!this.props.backLinkHref && !this.props.backLinkTo) {
        return null;
      }
    ...
    get: function get() {
      ...
      return (/*istanbul ignore next*/(0, _classnames2.default)("ui-heading", this.props.className, /*istanbul ignore next*/(_classNames = {}, _defineProperty(_classNames, "ui-heading--has-subheader", this.props.subheader), _defineProperty(_classNames, "ui-heading--has-back", this.props.backLinkHref || this.props.backLinkTo), _classNames))
      );
    }
  }]);
...
/*istanbul ignore next*/Heading.propTypes = {
   ...
   * @type {String}
   */
  backLinkHref: /*istanbul ignore next*/_react2.default.PropTypes.string,
   ...
   * @type {String}
   */
  backLinkTo: /*istanbul ignore next*/_react2.default.PropTypes.string
};
