...
var Row = _wrapComponent('Row')((_temp2 = _class = function (_React$Component) {
  ...
  function Row() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Row.__proto__ || Object.getPrototypeOf(Row)).call.apply(_ref, [this].concat(args))), _this), _this.buildColumns = function () {
      ...
      var childProps = (0, _lodash.omit)(child.props, ['columnOffset', 'columnSpan', 'columnClasses', 'columnAlign']);
      var newChild = _react3.default.createElement(child.type, childProps, child.props.children);
   ...
   * @type {String}
   */
  columns: _react3.default.PropTypes.string
}, _class.defaultProps = {
  gutter: "medium"
}, _temp2));
