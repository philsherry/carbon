...
var _Link = _wrapComponent('_Link')((_temp = _class = function (_React$Component) {
   ...
   * @default left
   */
  iconAlign: _react2.PropTypes.string,
   ...
   * @default true
   */
  tabbable: _react2.PropTypes.bool,
   ...
   * @type {String}
   */
  tooltipMessage: _react2.PropTypes.string,
   ...
   * @type {String}
   */
  tooltipPosition: _react2.PropTypes.string,
   ...
   * @type {String}
   */
  tooltipAlign: _react2.PropTypes.string
}, _class.defaultProps = {
  iconAlign: 'left',
  tabbable: true
}, _temp));
