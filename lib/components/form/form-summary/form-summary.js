...
FormSummary.propTypes = {
  errors: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.string, _react2.default.PropTypes.number]),
  warnings: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.string, _react2.default.PropTypes.number])
};
  ...
  if (props[pluralize(key)] > 0) {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'span',
        { className: 'carbon-form-summary__text', 'data-element': pluralize(key) },
