...
var Carousel = _wrapComponent('Carousel')((_temp = _class = function (_React$Component) {
   ...
   * @default firstTab
   */
  initialSlideIndex: _react3.default.PropTypes.oneOfType([_react3.default.PropTypes.number, _react3.default.PropTypes.string]),
   ...
   * @type {Object | Array}
   */
  children: _react2.PropTypes.oneOfType([_react3.default.PropTypes.array, _react3.default.PropTypes.object])
}, _class.defaultProps = {
  initialSlideIndex: 0
}, _temp));
