...
var Content = _wrapComponent('Content')((_temp = _class = function (_React$Component) {
   ...
   * @default left
   */
  align: _react2.PropTypes.string,
   ...
   * @type {String}
   */
  titleWidth: _react2.PropTypes.string,
   ...
   * @default false
   */
  bodyFullWidth: _react2.PropTypes.bool
}, _class.defaultProps = {
  align: 'left',
  as: 'primary',
  bodyFullWidth: false,
